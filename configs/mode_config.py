...
class ModeConfigManager:
    ...
    def from_args(cls, args: argparse.Namespace) -> "ModeConfigManager":
        ...
        config_kwargs = {
            ...
            if v is not None
            and k not in ["mode", "backend_mode"]
            and k in allowed_params
        }
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--work-dir", "-w", default="coding", help="Working directory (default: coding)"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Model temperature parameter (default: 1.0)",
    )
    ...
    parser.add_argument(
        "--use-docker", action="store_true", help="Use Docker to execute code"
    )
